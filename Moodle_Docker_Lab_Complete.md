...
```bash
```
<img width="959" height="241" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 09 25 04" src="https://github.com/user-attachments/assets/15275ce2-696f-4320-8719-1cf1a42782d5" />
...
```bash
```
<img width="943" height="420" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 09 32 58" src="https://github.com/user-attachments/assets/323032df-971e-4986-9697-4f67bacf6987" />
...
```bash
```
<img width="930" height="88" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 09 34 07" src="https://github.com/user-attachments/assets/3e6c8cd7-0ad4-4dac-a830-dcc7dd73fec1" />
...
```bash
```
<img width="922" height="161" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 09 40 59" src="https://github.com/user-attachments/assets/f4271385-229d-4efe-9312-3ad386f946ba" />
...
```bash
```
<img width="842" height="397" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 09 48 56" src="https://github.com/user-attachments/assets/09212a17-61c4-4003-8e3a-10786952a42e" />
...
```bash
```
<img width="1467" height="925" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 10 37 57" src="https://github.com/user-attachments/assets/3e0d9d75-e5b2-492f-bcb4-97c4e339158a" />
...
```bash
```
<img width="1470" height="956" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 11 03 41" src="https://github.com/user-attachments/assets/f4e7ba6a-c4bf-43fb-8948-d22f4db532ec" />
...
```bash
```
<img width="1470" height="956" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 11 15 44" src="https://github.com/user-attachments/assets/efbb3c40-cae1-4c79-9492-cbe82e1601e5" />

<img width="1470" height="956" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 11 15 25" src="https://github.com/user-attachments/assets/9be7d4af-bf69-4270-a668-05b063b0347a" />
...
```bash
```
<img width="1470" height="956" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 12 02 29" src="https://github.com/user-attachments/assets/00e7132e-34ec-4211-a31c-ee8a1b410bc3" />
...
```bash
```
<img width="1470" height="956" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 12 08 34" src="https://github.com/user-attachments/assets/494a54d2-f9c0-49ab-a1ad-edbab62def43" />
